...
class AudioEncoder:
    ...
    def __init__(self, model_path: str, dml_enable: bool = True, dml_device_id: int = 0, pad_to: int = 30):
        ...
        if self.dml_enable:
            ...
            if 'DmlExecutionProvider' in available_providers:
                ...
                dml_provider = ('DmlExecutionProvider', {
                    'device_id': str(self.dml_device_id), # 确保是字符串
                    'skip_options': 'False',
                    'disable_metacommands': 'False',
                    'enable_graph_capture': 'True',
                })
                providers.insert(0, dml_provider)
